...
{
    public partial class frmYiyecekDeposuİslemleri : Form
    {
        public frmYiyecekDeposuİslemleri()
        {
            InitializeComponent();
        }
        ...
        private void frmYiyecekDeposuİslemleri_Load(object sender, EventArgs e)
        {
            listele();
        }
